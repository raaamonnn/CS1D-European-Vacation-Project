...
void admin::on_pushButton_clicked() //adding a new food item
{
    ...
    if(isAlpha(checker))
    {
        if(isNum(checker2))
        {
            ...
            messageBox.critical(nullptr, "Error", "Invalid Price Input (only numeric characters allowed)");
...
void admin::on_pushButton_3_clicked() //change price of food item
{
    ...
    if(isAlpha(checker))
    {
        ...
        QMessageBox messageBox;
        messageBox.critical(nullptr, "Error", "Invalid Name Input (only alphabetic characters allowed)");
        messageBox.setFixedSize(500, 200);
    }
}
...
void admin::on_pushButton_2_clicked() //remove a food item entirely
{
    ...
    if(isAlpha(checker))
    {
        ...
        messageBox.critical(nullptr, "Error", "Invalid Input (only alphabetic characters allowed)");
        messageBox.setFixedSize(500, 200);
    }
}
